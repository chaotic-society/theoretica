...
namespace uroboro {
	...
	/// Compute \f$y \cdot log2(x)\f$ using x86 Assembly instructions
	...
	///
	/// Approximated as \f$e^{a \cdot ln(|x|) sgn(x)}\f$
	...
	/// @param tol Maximum difference to tolerate
